#!/bin/sh
exec > ${PROJECT_DIR}/testfairy_upload.txt 2>&1

IPA_FILENAME="${PRODUCT_NAME}.ipa"

xcodebuild -exportArchive -archivePath "$ARCHIVE_PATH" -exportPath "./" -exportOptionsPlist "${PROJECT_DIR}/export-options.plist"
